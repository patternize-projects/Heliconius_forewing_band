...
# load table with sex specification
...
rasterList_list_E <- list(rasterList_hydFG_M_sub, rasterList_hydP_M_sub, rasterList_dem_M_sub, rasterList_ven_M_sub, rasterList_fav_M_sub,  rasterList_phy_M_sub, rasterList_cyr_M_sub, rasterList_lat_M_sub, rasterList_emm_M_sub, rasterList_ety_M_sub, rasterList_not_M_sub, rasterList_mic_M_sub, rasterList_amal_M_sub, rasterList_era_M_sub)
rasterList_list_M <- list(rasterList_melFG_M_sub, rasterList_melP_M_sub, rasterList_ros_M_sub, rasterList_vul_M_sub, rasterList_amar_M_sub, rasterList_nan_M_sub, rasterList_cyt_M_sub, rasterList_mal_M_sub, rasterList_agl_M_sub, rasterList_ecu_M_sub, rasterList_ple_M_sub, rasterList_xen_M_sub, rasterList_mer_M_sub, rasterList_the_M_sub)


#figure creation 
png('comparison_subset_noNames_onlyMales.png', width=4000, height=11200)
...
for(e in 1:length(IDList_list_E)){
  IDList_E_df <- as.data.frame(IDList_list_E[[e]])
  colnames(IDList_E_df) <- 'Image.ID'
  IDList_E_sex <- merge(IDList_E_df, sexTable, by = 'Image.ID')
  IDList_E_sex_m <- as.numeric(rownames(subset(IDList_E_sex, IDList_E_sex$Sex == 'm')))
  summedRaster_E_M_sub_m <- sumRaster(rasterList_list_E[[e]], IDList_list_E[[e]][IDList_E_sex_m], type = 'RGB')
  
  IDList_M_df <- as.data.frame(IDList_list_M[[e]])
  colnames(IDList_M_df) <- 'Image.ID'
  IDList_M_sex <- merge(IDList_M_df, sexTable, by = 'Image.ID')
